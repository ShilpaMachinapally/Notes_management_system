        ...
        try:
            ...
            if entered_otp == data['otp']:
                ...
                if add_user:
                    ...
                    session.pop('register_otp_token')      
                    ...
                    return render_template('verifyotp.html',token=token, msg='User not added')

        except SignatureExpired:
            return render_template('verifyotp.html',token=token, msg='OTP Expired')
        except BadSignature:
            return render_template('verifyotp.html',token=token, msg='Invalid OTP URL')
        return render_template('verifyotp.html',token=token, msg='Invalid OTP')
        

    return render_template('verifyotp.html',token=token)
